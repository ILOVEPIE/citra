...
/**
 * Decode a color stored in RG8 (HILO8) format
 * @attention The technically correct name for this format is HILO8 due to it being big-endian regardless of archetecture, because the 3ds is little-endian we have used the name RG8 to prevent confusion.
 * @remark RG8 is not intended to store colors, the word color here is used just for consistency, RG8 is a format intended for normal maps.
 * @param bytes Pointer to encoded source color
 * @return Result color decoded as Math::Vec4<u8>
 */
...
/**
 * Encode a color as RG8 (HILO8) format
 * @attention The technically correct name for this format is HILO8 due to it being big-endian regardless of archetecture, because the 3ds is little-endian we have used the name RG8 to prevent confusion.
 * @remark RG8 is not intended to store colors, the word color here is used just for consistency, RG8 is a format intended for normal maps.
 * @param color Source color to encode
 * @param bytes Destination pointer to store encoded color
