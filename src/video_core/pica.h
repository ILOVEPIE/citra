...
struct Regs {
    ...
    enum class TextureFormat : u32 {
        ...
        RGBA4        =  4,
        IA8          =  5,
        RG8          =  6,  /// @attention The technically correct name for this format is HILO8 due to it being big-endian regardless of archetecture, because the 3ds is little-endian we have used the name RG8 to prevent confusion.
        I8           =  7,
        A8           =  8,
        IA4          =  9,
        I4           = 10,
